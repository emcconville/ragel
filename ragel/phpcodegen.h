 ...
 *            2014 Eric McConville <emcconville@emcconvile.com>
 */
...
#ifndef _PHPCODEGEN_H
#define _PHPCODEGEN_H
 ...
 * PhpTabCodeGen
 */
struct PhpTabCodeGen : public CodeGenData
{
	PhpTabCodeGen( ostream &out ) : 
		CodeGenData(out) {}
...
public:
	...
	string DATA_PREFIX();
	string PM() { return  DATA_PREFIX() + "_partition_map"; }
	string C() { return   DATA_PREFIX() + "_cond_spaces"; }
	string CK() { return  DATA_PREFIX() + "_cond_keys"; }
	string K() { return   DATA_PREFIX() + "_trans_keys"; }
	string I() { return   DATA_PREFIX() + "_indicies"; }
	string CO() { return  DATA_PREFIX() + "_cond_offsets"; }
	string KO() { return  DATA_PREFIX() + "_key_offsets"; }
	string IO() { return  DATA_PREFIX() + "_index_offsets"; }
	string CL() { return  DATA_PREFIX() + "_cond_lengths"; }
	string SL() { return  DATA_PREFIX() + "_single_lengths"; }
	string RL() { return  DATA_PREFIX() + "_range_lengths"; }
	string A() { return   DATA_PREFIX() + "_actions"; }
	string TA() { return  DATA_PREFIX() + "_trans_actions"; }
	string TT() { return  DATA_PREFIX() + "_trans_targs"; }
	string TSA() { return DATA_PREFIX() + "_to_state_actions"; }
	string FSA() { return DATA_PREFIX() + "_from_state_actions"; }
	string EA() { return  DATA_PREFIX() + "_eof_actions"; }
	string ET() { return  DATA_PREFIX() + "_eof_trans"; }
	string SP() { return  DATA_PREFIX() + "_key_spans"; }
	string CSP() { return DATA_PREFIX() + "_cond_key_spans"; }
